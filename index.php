      ...
      <div id="right-block" class="col-lg-6 col-sm-12">
        <div class="menu" id="menu">
          <div class="row">
            ...
            <div class="link-item col-lg-3 text-center">
              <div class="dropdown">
                <a onclick='window.location.href = "bands.php"' class="dropdown-toggle item-a" id="dropdownMenuButton"
                  data-toggle="dropdown" onmouseover='mouseover_button(event)'
                  onmouseout='mouseout_button(event)'>BANDS</a>
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" onmouseover='mouseover_menu(event)'
                  onmouseout='mouseout_menu(event)'>
        ...
        <div id="content-wrapper" class="content-wrapper">
          <h3 style="font-weight: 300; font-family: 'Cuprum', sans-serif;">ЛАСКАВО ПРОСИМО</h3>
          ...
          <div id="info-wrapper">
            ...
            <br>
            <a target="blank"
              href="https://uk.wikipedia.org/wiki/%D0%92%D0%B0%D0%B6%D0%BA%D0%B8%D0%B9_%D0%BC%D0%B5%D1%82%D0%B0%D0%BB_(%D0%BC%D1%83%D0%B7%D0%B8%D0%BA%D0%B0)">Читати
              на Вікіпедії</a></p>
          </div>
        </div>
      </div>
